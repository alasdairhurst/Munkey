...
exports.session = exports.main = exports.Database = undefined;
...
var main = exports.main = new Database(config.main),
    session = exports.session = new Database(config.session);